          ...
          <div className="mb-2 sm:mb-3">
            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
              <button
                ...
                className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs font-medium text-gray-600 hover:text-[#4C763B] transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-medium text-[#4C763B] border border-[#4C763B] rounded hover:bg-[#4C763B] hover:text-white transition-colors"
              >
                <svg className="h-3 w-3 sm:h-3.5 sm:w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
