...
export default function StudentTestInstructionsPage() {
  ...
  const handleStartTest = () => {
    navigate(ROUTES.STUDENT.TEST, { replace: true })
  }
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex items-center justify-center p-2 sm:p-3 lg:p-4 overflow-hidden">
      <div className="w-full max-w-6xl h-full flex flex-col justify-center">
        {/* Header Section */}
        <div className="text-center mb-2 sm:mb-3 animate-fadeIn">
          <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-br from-[#4C763B]/20 to-[#B0CE88]/20 mb-1.5 sm:mb-2 shadow-md animate-float">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-gray-100 p-2 sm:p-2.5 lg:p-3 mb-2 sm:mb-2.5 animate-slideUp">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            {instructions.map((instruction, index) => (
              <div
                key={index}
                className="flex items-center gap-2 sm:gap-2.5 p-1.5 sm:p-2 rounded-md border border-gray-200 hover:border-[#4C763B]/40 hover:bg-gradient-to-r hover:from-[#4C763B]/5 hover:to-[#B0CE88]/5 transition-all duration-200"
                style={{ animationDelay: `${index * 50}ms` }}
              >
                <div className="flex-shrink-0 flex items-center gap-1.5">
                  <span className="text-[#4C763B] text-sm font-bold">•</span>
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-md bg-gradient-to-br from-[#4C763B]/20 to-[#4C763B]/10 flex items-center justify-center text-[#4C763B]">
                    {instruction.icon}
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-[#4C763B]/10 via-[#B0CE88]/10 to-[#4C763B]/10 rounded-md border border-[#4C763B]/20 p-1.5 sm:p-2 mb-2 shadow-sm">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-md bg-[#4C763B]/20 flex items-center justify-center">
        ...
        <div className="text-center animate-fadeIn">
          ...
          >
            <span className="absolute inset-0 bg-gradient-to-r from-[#4C763B] to-[#043915] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
